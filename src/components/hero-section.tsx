        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-20 relative">
          ...
          >
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-[#f0f6fc] text-xs font-medium">Bug #142</span>
            </div>
          ...
          >
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-[#f0f6fc] text-xs font-medium">Feature #89</span>
            </div>
          ...
          >
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-[#f0f6fc] text-xs font-medium">AI Magic</span>
            </div>
          ...
          >
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-[#f0f6fc] text-xs font-medium">Task #301</span>
            </div>
          ...
          >
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-[#f0f6fc] text-xs font-medium">Critical #7</span>
            </div>
          ...
          >
            <div className="space-y-8">
              ...
              <motion.div className="space-y-6" variants={itemVariants}>
                <motion.h1
                  className="text-5xl sm:text-6xl lg:text-7xl font-bold text-[#f0f6fc] leading-tight"
                  variants={itemVariants}
                >
                ...
                <motion.p
                  ...
                  variants={itemVariants}
                >
                  Turn your messy backlog into a masterpiece. Our AI speaks fluent &quot;developer chaos&quot; and translates it
                  into actual plans.
                </motion.p>
              </motion.div>
